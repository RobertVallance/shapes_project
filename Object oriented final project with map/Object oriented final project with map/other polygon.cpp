...
// Translate the OtherPolygon by a certain (x, y)
void OtherPolygon::translate(const double x_translation, const double y_translation)
{
...
// Rescale the OtherPolygon
void polygonSpace::OtherPolygon::rescale(const double enlargement)
{
	// first find centre point of OtherPolygon (taken to be centre of mass)
	...
	x_centre_of_mass = x_coords_sum / number_sides;
	y_centre_of_mass = y_coords_sum / number_sides;
...
// Rotate the OtherPolygon
void polygonSpace::OtherPolygon::rotate(const double angle)
{
	...
	// Now find centre point of OtherPolygon (taken to be centre of mass)
	double x_centre_of_mass, y_centre_of_mass;
	double x_coords_sum{ 0.0 }, y_coords_sum{ 0.0 };
