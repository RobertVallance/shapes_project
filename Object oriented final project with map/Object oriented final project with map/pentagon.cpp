...
// Translate the pentagon by a certain (x, y)
void Pentagon::translate(const double x_translation, const double y_translation)
{
	for (int i{ 0 }; i < 5; i++)
	{
...
// Rescale the pentagon
void polygonSpace::Pentagon::rescale(const double enlargement)
{
	// first find centre point of pentagon (taken to be centre of mass)
	...
	x_centre_of_mass = x_coords_sum / 5.0;
	y_centre_of_mass = y_coords_sum / 5.0;
...
// Rotate the pentagon
void polygonSpace::Pentagon::rotate(const double angle)
{
	...
	// Now find centre point of pentagon (taken to be centre of mass)
	double x_centre_of_mass, y_centre_of_mass;
	double x_coords_sum{ 0.0 }, y_coords_sum{ 0.0 };
