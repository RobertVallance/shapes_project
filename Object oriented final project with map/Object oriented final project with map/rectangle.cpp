...
// Translate the rectangle by a certain (x, y)
void Rectangle::translate(const double x_translation, const double y_translation)
{
	for (int i{ 0 }; i < 4; i++)
	{
...
void polygonSpace::Rectangle::rescale(const double enlargement)
{
	...
	x_centre_of_mass = x_coords_sum / 4.0;
	y_centre_of_mass = y_coords_sum / 4.0;
...
void polygonSpace::Rectangle::rotate(const double angle)
{
	...
	// Now find centre point of rectangle (taken to be centre of mass)
